(function () {
    var h = {}, mt = {}, c = {
        id: "a3b242930672e1d3dd7781c8cd80b09a",
        dm: ["tooxiu.com"],
    ...
    mt.cookie.set = function (a, b, d) {
        ...
        document.cookie = a + "=" + b + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (f ? "; expires=" + f.toGMTString() : "") + (d.lb ? "; secure" : "")
    };
    ...
    (function () {
        ...
        mt.f.Ca = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : q;
    ...
    h.s = {
        ...
        Va: 1,
        R: 2147483647,
        ca: "kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn ct u tt".split(" ")
    };
    (function () {
        var a = {
            p: {}, c: function (a, d) {
    ...
    (function () {
        ...
        var d = mt.lang, f = mt.l, g = mt.f, n = h.s, l = h.H, p = h.ia, e = {
            w: [], C: 0, Z: u, o: {V: "", page: ""}, init: function () {
                e.e =
                    0;
                l.c("pv-b", function () {
                    e.ka();
                ...
                if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                    ...
                    e.Z || (h.b.a.su = document.location.href);
                    h.b.j();
                    h.b.a.u = b;
                    h.b.a.su = d
                }
            ...
            _trackEvent: function (a) {
                ...
                1 <
                a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? n.protocol + "//" + window.location.host + a[1] : a[1], e.Z = r)
                ...
                if (1 < a.length && (a = a[1], u === a || r === a)) h.b.Y = a
            }
        };
        e.init();
        h.ga = e;
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = r, this.a = {}, this.Y = this.X = r, this.O = u, this.init())
        }

        var b = mt.url, d = mt.ba, f = mt.U, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage,
        ...
        a.prototype = {
            P: function (a, b) {
                ...
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.$(document.location.href, d))return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            }, ua: function () {
                ...
                for (var a = [], b = this.a.et, d = 0, e = k.ca.length; d < e; d++) {
                    var f = k.ca[d], g = this.a[f];
                ...
                this.a.cp = b.i(a, k.Aa) || b.i(a, k.Sa) || "";
                this.a.cw = b.i(a, k.ya) || b.i(a, k.Ua) || "";
                this.a.ci = b.i(a, k.wa) || b.i(a, k.Ra) || "";
                this.a.cf = b.i(a, k.Ba) || b.i(a, k.Ta) || "";
                this.a.cu = b.i(a, k.xa) || b.i(a, k.Qa) || ""
            }, init: function () {
                try {
                    this.Oa(), 0 === this.a.nv ? this.La() : this.T(".*"), h.b = this, this.ha(), w.z("pv-b"), this.Ka()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id),
                    e = b.K(document.referrer) === k.fa ? 1 : 0, f = b.i(a, "jn"),
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                da: function () {
                    for (var b = c.cvcf.length, f, p = 0; p < b; p++)(f = a.pa(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.la())
                }, la: function () {
                    return function () {
                        h.b.a.et = 86;
                        var a = {n: "form", t: "clk"};
