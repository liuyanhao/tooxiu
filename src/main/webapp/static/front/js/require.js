...
!function (global) {
    ...
    function newContext(e) {
        ...
        function o(e, t, r, n) {
            ...
            return e || (l = !1, e = "_@r" + (R += 1)), c = a(e), d = c[0], e = c[1], d && (d = i(d, p, n), s = getOwn(j, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
                return i(e, p, n)
            }) : e.indexOf("!") === -1 ? i(e, p, n) : e : (h = i(e, p, n), c = a(h), d = c[0], h = c[1], r = !0, o = q.nameToUrl(h))), u = !d || s || r ? "" : "_unnormalized" + (T += 1), {
                prefix: d,
                name: h,
                parentMap: t,
                unnormalized: !!u,
        ...
        return E = {
            ...
            init: function (e, t, i, r) {
                ...
                this.depMaps.push(r), u(r, "defined", bind(this, function (r) {
                    var n, a, d, f = getOwn(A, this.map.id), l = this.map.name,
            ...
            nameToUrl: function (e, t, i) {
                ...
                if (d && (e = d), c = getOwn(A, e))return q.nameToUrl(c, t, i);
                ...
                if (isFunction(y.urlArgs)) {
                    var p;
                    try {
                        p = y.urlArgs.call(y, e, s)
                    } catch (f) {
                        p = ""
                    }
                    return s += p.length ? (s.indexOf("?") === -1 ? "?" : "&") + p : ""
                }
            ...
            onScriptError: function (e) {
                var t = g(e);
                if (!n(t.id))return c(makeError("scripterror", "Script error for: " + t.id, e, [t.id]))
            }
