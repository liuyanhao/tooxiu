...
//设置站内信声音提示类型
function setLXCsmsSoundType(type){
	$("#LXCsmsSound").val(type);
	if('0' != type){
		$("#lxcsmsobjsys").html('<audio style="display: none;" id="lxcsmstsy" src="static/sound/'+type+'.mp3" autoplay controls></audio>');
	}
}
