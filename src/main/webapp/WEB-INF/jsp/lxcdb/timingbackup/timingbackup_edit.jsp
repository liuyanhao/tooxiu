					...
					<form action="timingbackup/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="LXCTIME" id="LXCTIME" value="${pd.LXCTIME}" maxlength="30" placeholder="这里输入时间规则" title="时间规则" style="width:98%;"/></td>
							</tr>
							<tr>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;" id="setLXCTIME">设定:</td>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function setTimegz(value,type){
			...
			$("#LXCTIME").val("0 0 "+hour + " " + day + " " + month + " " + week);
