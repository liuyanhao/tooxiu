		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="tooxiuPictures/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	function delP(PATH,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "tooxiuPictures/deltp.do?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&guid="+new Date().getTime();
