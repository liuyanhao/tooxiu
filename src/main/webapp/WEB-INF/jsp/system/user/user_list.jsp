										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-info" title='发送站内信' onclick="sendLxcsms('${user.USERNAME }');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.LXCSMS == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="sendLxcsms('${user.USERNAME }');" class="tooltip-info" data-rel="tooltip" title="发送站内信">
																	<span class="blue">
