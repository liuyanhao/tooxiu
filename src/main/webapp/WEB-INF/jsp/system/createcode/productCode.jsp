					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 10px;">
							<tr>
								...
								<td>
									<select name="LXCTYPE" id="LXCTYPE" data-placeholder="请选择数据库"  style="vertical-align:top;width: 87px;" onchange="selectType(this.value)">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td colspan="1"><input type="text" name="packageName" id="packageName" value="${pd.PACKAGENAME }" placeholder="输入包名  (不要输入特殊字符,请用纯字母)" style="width:259px" title="包名称"/></td>
								<td>&nbsp;&nbsp;例如:com.lxc.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : ''}${fn:split(pd.TABLENAME, ',lxc,')[0]}" placeholder="这里输入表前缀" style="width:156px" title="表前缀"/></td>
							</tr>
						</table>
...
<!-- /.main-container -->	
		...
		function reductionFields(){
			...
			if('edit' == msg){
				...
				var fieldarray = nowarField.split('Q1094921525');
