...
<base href="<%=basePath%>">
	...
	<!-- 表单构建组建 -->
	<link rel="shortcut icon" href="favicon.ico"> <link href="plugins/lxcform/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="plugins/lxcform/css/animate.min.css" rel="stylesheet">
    <link href="plugins/lxcform/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
	<!-- 日期框 -->
...
<body class="gray-bg">
											                        ...
											                        <form class="form-horizontal m-t">
											                            ...
											                            <div class="form-group draggable">
											                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">下拉框：</label>
																				...
																				<div class="selQ1094921525sel"></div>
																				<select class="chosen-select form-control" name="name" id="id" data-placeholder="请选择">
																			  	...
																			  	<div class="selQ1094921525Qsel"></div>
																			</div>
											                            </div>
											                            <div class="form-group draggable">
											                            ...
											                            <div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQ1094921525Qfile"></div>
											                            ...
											                            <div class="form-group draggable">
											                                ...
											                                <div class="col-sm-9">
											                                	<div class="ueQ1094921525Que"></div>
	...
	<!-- 表单构建组建 -->
    <script src="plugins/lxcform/js/bootstrap.min.js?v=3.3.5"></script>
    <script src="plugins/lxcform/js/content.min.js?v=1.0.0"></script>
    <script src="plugins/lxcform/js/jquery-ui-1.10.4.min.js"></script>
    <script src="plugins/lxcform/js/beautifyhtml/beautifyhtml.js"></script>
	<!-- 百度富文本编辑框-->
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQ194921525Que"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQ1094921525Que"></div>' + uejscode + '<div class="ueQ1094921525Que"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQ1094921525Que"></div>' + ueditorHtml + '<div class="ueQ1094921525Que"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQ1094921525Qsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQ1094921525Qsel"></div>' + selectcode + '<div class="selQ1094921525Qsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQ1094921525Qfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQ1094921525Qfile"></div>' + filecode + '<div class="fileQ1094921525Qfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQ1094921525Qfile"></div>' + fileHtml + '<div class="fileQ1094921525Qfile"></div>' + arryFile[2];
				};
			}else{
