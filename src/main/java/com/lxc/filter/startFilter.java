...
import com.lxc.plugin.websocketInstantMsg.ChatServer;
import com.lxc.plugin.websocketOnline.OnlineChatServer;
...
public class startFilter extends BaseController implements Filter{
	...
	public void reductionDbBackupQuartzState(){
		try {
			DbLXC.executeUpdateLXC("update DB_TIMINGBACKUP set STATUS = '2'");
