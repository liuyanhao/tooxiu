...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("LXChrAdminqq1094921525")){
			...
			String toUser = message.substring(message.indexOf("lxchradmin886")+10, message.indexOf("lxchradmin888"));
			message = message.substring(0, message.indexOf("lxcadmin886")) +"[私信]  "+ message.substring(message.indexOf("lxchradmin888")+12, message.length());
