...
import com.lxc.service.lxcdb.brdb.impl.BRdbService;
import com.lxc.service.lxcdb.timingbackup.impl.TimingBackUpService;
...
public class DbBackupQuartzJob extends BaseController implements Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			String kackupPath = DbLXC.getDbLXC().backup(TABLENAME).toString();//调用数据库备份
