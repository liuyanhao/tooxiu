package com.lxc.controller.lxcdb.timingbackup;
...
import com.lxc.util.QuartzManager;
import com.lxc.util.Tools;
import com.lxc.service.lxcdb.timingbackup.TimingBackUpManager;
...
public class TimingBackUpController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		String LXCTIME = pd.getString("LXCTIME");									//时间规则
		...
		this.addJob(JOBNAME, LXCTIME, TABLENAME,TIMINGBACKUP_ID);				//添加任务
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lxcdb/timingbackup/timingbackup_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("lxcdb/timingbackup/timingbackup_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("LXCTIME"));	//5
	 ...
	 */
	public void addJob(String JOBNAME, String LXCTIME, String TABLENAME, String TIMINGBACKUP_ID){
		Map<String,Object> parameter = new HashMap<String,Object>();
		parameter.put("TABLENAME", TABLENAME);
		parameter.put("TIMINGBACKUP_ID", TIMINGBACKUP_ID);
		QuartzManager.addJob(JOBNAME,JOB_GROUP_NAME, JOBNAME, TRIGGER_GROUP_NAME, DbBackupQuartzJob.class, LXCTIME ,parameter);
	}
