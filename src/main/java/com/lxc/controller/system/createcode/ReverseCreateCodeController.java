...
public class ReverseCreateCodeController extends BaseController {
	...
	public Object listAllTable(){
		...
		try {
			Object[] arrOb = DbLXC.getTables(pd);
	...
	public ModelAndView goProductCode() throws Exception{
		...
		List<Map<String,String>> columnList = DbLXC.getFieldParameterLsit(DbLXC.getLXCCon(pd),pd.getString("table")); //读取字段信息
