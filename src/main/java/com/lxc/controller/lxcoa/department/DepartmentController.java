package com.lxc.controller.lxcoa.department;
...
import com.lxc.service.lxcoa.department.DepartmentManager;
...
public class DepartmentController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lxcoa/department/department_list");
	...
	public ModelAndView listAllDepartment(Model model,String DEPARTMENT_ID)throws Exception{
		...
		try{
			...
			mv.addObject("pd", pd);	
			mv.setViewName("lxcoa/department/department_ztree");
		} catch(Exception e){
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("lxcoa/department/department_edit");
