package com.lxc.controller.information.attached;
...
import com.lxc.service.information.attached.AttachedManager;
import com.lxc.service.information.attachedmx.AttachedMxManager;
...
public class AttachedController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("FDESCRIBES"));	    //2
